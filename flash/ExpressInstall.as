/**
 * ExpressInstall class v0.9 - http://blog.deconcept.com/flashobject/
 * 
...
class ExpressInstall {
   ...
   function ExpressInstall() {
      // register installStatus as a root function for the updater to call [?]
      _root.installStatus = this.installStatus;	
   }
